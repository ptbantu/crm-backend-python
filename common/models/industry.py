...
class Industry(Base):
    ...
    # 行业代码（唯一）
    code = Column(String(100), nullable=False, unique=True, index=True, comment="行业代码")
    
    # 双语名称
    name_zh = Column(String(255), nullable=False, comment="行业名称（中文）")
    name_id = Column(String(255), nullable=False, comment="行业名称（印尼语）")
