...
class Organization(Base):
    ...
    organization_type = Column(String(50), nullable=False, index=True, comment="internal: BANTU内部组织, vendor: 交付组织(做单组织), agent: 外部代理(销售组织)")
    ...
    # 公司属性
    company_size = Column(String(50), nullable=True, comment="micro, small, medium, large, enterprise")
    company_nature = Column(String(50), nullable=True, comment="state_owned, private, foreign, etc.")
    company_type = Column(String(50), nullable=True, comment="limited, unlimited, partnership, etc.")
    ...
    company_status = Column(String(50), nullable=True, comment="normal, cancelled, etc.")
