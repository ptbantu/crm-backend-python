...
-- ============================================
-- 3. 删除字段（直接删除，不使用动态SQL）
-- ============================================

-- 删除旧的价格字段（单货币）
ALTER TABLE products DROP COLUMN IF EXISTS price_list;
ALTER TABLE products DROP COLUMN IF EXISTS price_channel;
ALTER TABLE products DROP COLUMN IF EXISTS price_cost;

-- 删除销售价格字段（多货币）
ALTER TABLE products DROP COLUMN IF EXISTS price_channel_idr;
ALTER TABLE products DROP COLUMN IF EXISTS price_channel_cny;
ALTER TABLE products DROP COLUMN IF EXISTS price_direct_idr;
ALTER TABLE products DROP COLUMN IF EXISTS price_direct_cny;
ALTER TABLE products DROP COLUMN IF EXISTS price_list_idr;
ALTER TABLE products DROP COLUMN IF EXISTS price_list_cny;

-- 删除汇率相关字段
ALTER TABLE products DROP COLUMN IF EXISTS exchange_rate;
ALTER TABLE products DROP COLUMN IF EXISTS default_currency;
