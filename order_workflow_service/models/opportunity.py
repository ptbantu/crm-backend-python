...
class Opportunity(Base):
    ...
    creator = relationship("User", foreign_keys=[created_by], backref="created_opportunities")
    updater = relationship("User", foreign_keys=[updated_by], backref="updated_opportunities")
...
class OpportunityProduct(Base):
    ...
    # 关系
    opportunity = relationship("Opportunity", foreign_keys=[opportunity_id], back_populates="products")
    product = relationship("Product", foreign_keys=[product_id], backref="opportunity_products")
...
class OpportunityPaymentStage(Base):
    ...
    # 关系
    opportunity = relationship("Opportunity", foreign_keys=[opportunity_id], back_populates="payment_stages")
